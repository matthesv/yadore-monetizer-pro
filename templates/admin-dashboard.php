<div class="wrap yadore-admin-wrap">
    <h1 class="yadore-page-title">
        ...
        <span class="version-badge">v2.9.13</span>
    </h1>

    <?php if (get_transient('yadore_activation_notice')): ?>
    <div class="notice notice-success is-dismissible">
        <p><strong>Yadore Monetizer Pro v2.9.13 activated successfully!</strong> All features are now available.</p>
    </div>
                    ...
                    <div class="system-status">
                        <div class="status-item">
                            ...
                            <div class="status-details">
                                ...
                                <small>v2.9.13 - All systems operational</small>
                            </div>
                        </div>
                ...
                <div class="card-content">
                    <div class="version-info">
                        <div class="info-row">
                            ...
                            <span class="info-value version-current">v2.9.13</span>
                        </div>
                        <div class="info-row">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value">Enhanced v2.9.13</span>
                        </div>
                        <div class="info-row">
...
function yadoreInitializeDashboard() {
    console.log('Yadore Monetizer Pro v2.9.13 Dashboard - Initialized');
}
